...
export function SignFormClient({
  loadUrl,
  submitUrl,
  homeHref,
  homeLabel,
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50 p-4">
        <div className="max-w-md rounded-2xl border border-slate-200 bg-white p-8 text-center">
          <CheckCircle className="mx-auto mb-4 h-16 w-16 text-emerald-500" aria-hidden="true" />
          <h1 className="mb-2 text-2xl font-bold text-gray-900">Permission submitted</h1>
          <p className="mb-6 text-gray-600">
            You&apos;re done. A confirmation was sent if email is configured for this school.
          </p>
          <Link
            href={doneHref}
